...
- **Machine Learning Model**
  <h3>
    <ol>
      <li>
        <p>Data Science Based Classification Model</p>
          <p>This model has been trained with neural network architecture with 100% of evaluation accuracy</p>
      ...
      <p>&nbsp;&nbsp;</p>
      <li>
        <p>Natural Language Processing Based Classification Model</p>
          <p>This model using transfer learning and fine-tuning with 99.1% of evaluation accuracy</p>
          <div style="text-align:center;">
            <ol>
              <p>Model Performance</p>
